        ...
        return new OpenAPI()
                .info(new Info()
                        ...
                        .description("""
                                ...
                                """)
                        .contact(new Contact()
                                .name("ScienceBot POS Team")
                                .email("soporte@sciencebot.com")
                                .url("https://sciencebot.com"))
                        .license(new License()
                                .name("Propietario - ScienceBot")
                                .url("https://sciencebot.com/licencia")))
                .servers(List.of(
                        new Server()
                                .url("http://localhost:8080")
                                .description("Servidor local de desarrollo"),
                        new Server()
                                .url("https://api.sciencebot.com")
