    ...
    <>
      ...
      >
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            {(!isCollapsed || isOpen) && (
              <div className="truncate">
                ...
                <p className="text-[10px] text-gray-400 font-semibold tracking-wide">Tu negocio, en equilibrio</p>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="shrink-0 flex flex-col gap-2 w-full px-3 pt-3 border-t border-[#e2e8f0] dark:border-[#262f38]">
          ...
          <button 
            title="Soporte"
            className={`flex items-center gap-3 p-2.5 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-[#262f38] hover:text-[#c83824] dark:hover:text-[#ea6a58] rounded-2xl transition-all cursor-pointer text-xs font-semibold ${
