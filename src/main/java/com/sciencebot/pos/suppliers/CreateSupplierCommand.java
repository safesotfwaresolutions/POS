...
public record CreateSupplierCommand(
        @Schema(description = "Razón social de la empresa", example = "Distribuidora Central S.A.S.", requiredMode = Schema.RequiredMode.REQUIRED)
        String companyName,
        @Schema(description = "NIT o RUT de la empresa", example = "900123456-7", requiredMode = Schema.RequiredMode.REQUIRED)
        String taxId,
